...
void ggml_compute_forward_supertonic_depthwise_1d(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_supertonic_layer_norm_channel(const struct ggml_compute_params * params, struct ggml_tensor * dst);
